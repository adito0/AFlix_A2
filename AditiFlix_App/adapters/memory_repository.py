...
def test_populate():
    ...
    assert repr(repo.get_users()) == "[<User aram485>, <User doggirl>, <User deedee>, <User markrulesworld>, <User noname>]"
    assert repr(repo.get_reviews()) == "[<Rating 9.0, Review I love this movie so much!! It really makes you think>, <Rating 8.0, Review This one is great for the kids with a good laugh and what not>, <Rating 5.0, Review This movie was alright. I couldn't even finish it because it was so boring>, <Rating 10.0, Review Wow!>]"
    assert repr(repo.get_movies()) == "[<Movie Guardians of the Galaxy, 2014>, <Movie Lion, 2019>, <Movie Prometheus, 2012>, <Movie Sing, 2016>, <Movie Split, 2016>, <Movie Suicide Squad, 2016>]"
